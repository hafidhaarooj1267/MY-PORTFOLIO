...
const projects = [
    ...
    {id: 2, title: "Evaccination Management System", pillar: "fe", tools: ["HTML", "CSS", "JS","PHP","MYSQL"], desc: "PHP + MySQL + JavaScript. Vaccination record management by hospitals. Parents can register childs for vaccination, and admin can check and verify all records.", detail: "Custom interactive portfolio with theme switcher and full-page animations.",github: "evaccination-system.vercel.app", img: "images/evaccinationimage.png", icon: "🎨"},
